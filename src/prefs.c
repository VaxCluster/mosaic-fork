...
void set_pref(long pref_id, void *incoming)
{
    ...
    case eTRACK_VISITED_ANCHORS:
        thePrefsStructP->RdataP->track_visited_anchors = *((Boolean *) incoming);
        break;
    case eDISPLAY_URLS_NOT_TITLES:
        thePrefsStructP->RdataP->display_urls_not_titles = *((Boolean *) incoming);
        break;
    case eTRACK_POINTER_MOTION:
        thePrefsStructP->RdataP->track_pointer_motion = *((Boolean *) incoming);
        break;
    case eTRACK_FULL_URL_NAMES:
        thePrefsStructP->RdataP->track_full_url_names = *((Boolean *) incoming);
        break;
    case eANNOTATIONS_ON_TOP:
        thePrefsStructP->RdataP->annotations_on_top = *((Boolean *) incoming);
        break;
    case eCONFIRM_DELETE_ANNOTATION:
        thePrefsStructP->RdataP->confirm_delete_annotation = *((Boolean *) incoming);
        break;
    case eANNOTATION_SERVER:
    ...
    case eRECORD_COMMAND:
        ...
        break;
    case eRELOAD_PRAGMA_NO_CACHE:
        thePrefsStructP->RdataP->reload_pragma_no_cache = *((Boolean *) incoming);
        break;
    case eSENDMAIL_COMMAND:
    ...
    case eMAIL_FILTER_COMMAND:
        ...
        break;
    case ePRIVATE_ANNOTATION_DIRECTORY:
        thePrefsStructP->RdataP->private_annotation_directory = (char *)incoming;
        break;
    case eHOME_DOCUMENT:
    ...
    case eDOCUMENTS_MENU_SPECFILE:
        ...
        break;
    case eCOLORS_PER_INLINED_IMAGE:
        thePrefsStructP->RdataP->colors_per_inlined_image = *((int *)incoming);
        break;
    case eIMAGE_CACHE_SIZE:
        thePrefsStructP->RdataP->image_cache_size = *((int *)incoming);
        break;
    case eRELOAD_RELOADS_IMAGES:
        thePrefsStructP->RdataP->reload_reloads_images = *((Boolean *) incoming);
        break;
    case eREVERSE_INLINED_BITMAP_COLORS:
        thePrefsStructP->RdataP->reverse_inlined_bitmap_colors = *((Boolean *) incoming);
        break;
    case eDELAY_IMAGE_LOADS:
    ...
    case eGUNZIP_COMMAND:
        ...
        break;
    case eUSE_DEFAULT_EXTENSION_MAP:
        thePrefsStructP->RdataP->use_default_extension_map = *((Boolean *) incoming);
        break;
    case eUSE_DEFAULT_TYPE_MAP:
        thePrefsStructP->RdataP->use_default_type_map = *((Boolean *) incoming);
        break;
    case eGLOBAL_EXTENSION_MAP:
    ...
    case ePERSONAL_TYPE_MAP:
        ...
        break;
    case eTWEAK_GOPHER_TYPES:
        thePrefsStructP->RdataP->tweak_gopher_types = *((Boolean *) incoming);
        break;
    case ePRINT_MODE:
    ...
    case eCCIPORT:
        ...
        break;
    case eMAX_NUM_OF_CCI_CONNECTIONS:
        thePrefsStructP->RdataP->max_num_of_cci_connections = *((int *)incoming);
        break;
    case eMAX_WAIS_RESPONSES:
    ...
    case eAUTO_PLACE_WINDOWS:
        ...
        break;
    case eINITIAL_WINDOW_ICONIC:
        thePrefsStructP->RdataP->initial_window_iconic = *((Boolean *) incoming);
        break;
    case eTITLEISWINDOWTITLE:
    ...
    case eUSETEXTBUTTONBAR:
        ...
        break;
    case eTWIRLING_TRANSFER_ICON:
        thePrefsStructP->RdataP->twirling_transfer_icon = *((Boolean *) incoming);
        break;
    case eSECURITYICON:
    ...
    case eSAVE_MODE:
        ...
        break;
    case eHDF_MAX_IMAGE_DIMENSION:
        thePrefsStructP->RdataP->hdf_max_image_dimension = *((int *)incoming);
        break;
    case eHDF_MAX_DISPLAYED_DATASETS:
        thePrefsStructP->RdataP->hdf_max_displayed_datasets = *((int *)incoming);
        break;
    case eHDF_MAX_DISPLAYED_ATTRIBUTES:
        thePrefsStructP->RdataP->hdf_max_displayed_attributes = *((int *)incoming);
        break;
    case eHDF_POWER_USER:
    ...
    case eLOAD_LOCAL_FILE:
        ...
        break;
    case eEDIT_COMMAND_USE_XTERM:
        thePrefsStructP->RdataP->edit_command_use_xterm = *((Boolean *) incoming);
        break;
    case eCONFIRM_EXIT:
        thePrefsStructP->RdataP->confirm_exit = *((Boolean *) incoming);
        break;
    case eDEFAULT_FANCY_SELECTIONS:
        thePrefsStructP->RdataP->default_fancy_selections = *((Boolean *) incoming);
        break;
    case eCATCH_PRIOR_AND_NEXT:
        thePrefsStructP->RdataP->catch_prior_and_next = *((Boolean *) incoming);
        break;
    case eSIMPLE_INTERFACE:
        thePrefsStructP->RdataP->simple_interface = *((Boolean *) incoming);
        break;
    case ePROTECT_ME_FROM_MYSELF:
        thePrefsStructP->RdataP->protect_me_from_myself = *((Boolean *) incoming);
        break;
    case eGETHOSTBYNAME_IS_EVIL:
        thePrefsStructP->RdataP->gethostbyname_is_evil = *((Boolean *) incoming);
        break;
#ifdef __sgi
    case eDEBUGGING_MALLOC:
...
/* New in 2.7 */
    ...
    case eSCREEN_GAMMA:
        ...
        break;
    case eDISABLEMIDDLEBUTTON:
        thePrefsStructP->RdataP->disableMiddleButton = *((Boolean *) incoming);
        break;
    case eHTTPTRACE:
    ...
    case eURLEXPIRED:
        ...
        break;
    case ePOPUPCASCADEMAPPINGDELAY:
        thePrefsStructP->RdataP->popupCascadeMappingDelay = *((int *)incoming);
    ...
    case eFOCUS_FOLLOWS_MOUSE:
        ...
        break;
    case eSESSION_HISTORY_ON_RBM:
        thePrefsStructP->RdataP->sessionHistoryOnRBM = *((Boolean *) incoming);
        break;
    case eNUMBER_OF_ITEMS_IN_RBM_HISTORY:
