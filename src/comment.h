...
/* External HTML parts */
extern const char *comment_card_html_top;
extern const char *comment_card_html_bot;

extern void CommentCard(struct mo_window *win);
extern char *MakeFilename(void);
