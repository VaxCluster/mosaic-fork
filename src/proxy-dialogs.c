...
EditNoProxyInfo(), CenterDialog(), ProxyHelpWindow(), HelpWindow(), DisableProxy();
...
void PopProxyDialog(mo_window *win, struct Proxy *list, int fProxy)
{
    ...
    ProxyDialog = XtVaCreatePopupShell("Proxies",
                                       ...
                                       XtParent(win->base), XmNdeleteResponse, XmDESTROY, XmNtitle, "Proxies", NULL);

    fProxyDialog = 1;

    main_form = XtVaCreateWidget("proxy_form", xmFormWidgetClass, ProxyDialog, NULL);
    ...
    action_area = XtVaCreateWidget("proxy_action",
                                   ...
                                   XmNbottomAttachment, XmATTACH_FORM, XmNfractionBase, 6, NULL);
    ...
    save = XtVaCreateManagedWidget("Save",
                                   ...
                                   XmNrightPosition, 2,
                                   XmNshowAsDefault, True, XmNdefaultButtonShadowThickness, 1, NULL);
    ...
    XtSetArg(args[n], XmNwidth, 150);
    n++;
    XtSetArg(args[n], XmNvisibleItemCount, 10);
    n++;
    XtSetArg(args[n], XmNmargin, 1);
    n++;
    ...
    n++;
    XtSetArg(args[n], XmNbottomWidget, action_area);
    n++;
    if (font)
...
void HelpWindow(Widget w, XtPointer client, XtPointer call)
{
    ...
    mo_open_another_window(mo_main_window, mo_assemble_help_url(html_file), NULL, NULL);
}
...
void CenterDialog(Widget dialog, XtPointer client, XtPointer call)
{
    ...
    XtVaGetValues(mo_main_window->base, XmNx, &x, XmNy, &y, XmNwidth, &width, XmNheight, &height, NULL);

    XtVaGetValues(dialog, XmNwidth, &dia_width, XmNheight, &dia_height, NULL);
    ...
    XtVaSetValues(dialog, XmNx, dia_center_x, XmNy, dia_center_y, NULL);
}
...
XmString GetStringFromScrolled(Widget w)
{
    ...
    XtVaGetValues(w, XmNselectedItemCount, &selected_count, XmNselectedItems, &selected_table, NULL);
...
void EditNoProxyInfo(w, client, call, type)
Widget w;
XtPointer client;
XtPointer call;
int type;
{
    ...
    EditNoProxyDialog = XtVaCreatePopupShell("Proxies",
                                             xmDialogShellWidgetClass,
                                             XtParent(w), XmNdeleteResponse,
                                             XmDESTROY, XmNtitle, "No_Proxy Information", NULL);

    fEditProxyDialog = 1;
    main_form = XtVaCreateWidget("edit_form", xmFormWidgetClass, EditNoProxyDialog, NULL);
    /*
     ** Create action area widgets
     */
    action_area = XtVaCreateWidget("edit_action",
                                   ...
                                   XmNleftAttachment, XmATTACH_FORM,
                                   XmNrightAttachment, XmATTACH_FORM,
                                   XmNbottomAttachment, XmATTACH_FORM, XmNfractionBase, 3, NULL);
    ...
    rc = XtVaCreateWidget("rowcolumn",
                          ...
                          XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget, action_area, NULL);

    text_form = XtVaCreateWidget("text_form", xmFormWidgetClass, rc, NULL);
    ...
    form = XtVaCreateWidget("form1", xmFormWidgetClass, rc2, XmNfractionBase, 10, NULL);
    ...
    address = XtVaCreateManagedWidget("Address",
                                      ...
                                      XmNbottomAttachment, XmATTACH_FORM,
                                      XmNleftAttachment, XmATTACH_POSITION,
                                      XmNleftPosition, 0, XmNalignment, XmALIGNMENT_END, NULL);
    ...
    pEditInfo->IF->addr_text = XtVaCreateManagedWidget("addr_text",
                                                       ...
                                                       XmNleftAttachment,
                                                       XmATTACH_POSITION,
                                                       XmNleftPosition, 3, XmNrightAttachment, XmATTACH_FORM, NULL);

    XtManageChild(form);

    form = XtVaCreateWidget("form2", xmFormWidgetClass, rc2, XmNfractionBase, 10, NULL);
    ...
    pEditInfo->IF->port_text = XtVaCreateManagedWidget("port_text",
                                                       ...
                                                       XmNleftAttachment,
                                                       XmATTACH_POSITION,
                                                       XmNleftPosition, 3, XmNmaxLength, 5, XmNcolumns, 6, NULL);
    XtManageChild(form);
...
void EditProxyInfo(w, client, call, type)
Widget w;
XtPointer client;
XtPointer call;
int type;
{
    ...
    EditProxyDialog = XtVaCreatePopupShell("Proxies",
                                           xmDialogShellWidgetClass,
                                           XtParent(w), XmNdeleteResponse,
                                           XmDESTROY, XmNtitle, "Proxy Information", NULL);

    fEditProxyDialog = 1;
    main_form = XtVaCreateWidget("edit_form", xmFormWidgetClass, EditProxyDialog, NULL);
    /*
     ** Create action area widgets
     */
    action_area = XtVaCreateWidget("edit_action",
    ...
    label = XtVaCreateManagedWidget("Proxy",
                                    ...
                                    XmNtopAttachment, XmATTACH_FORM,
                                    XmNleftAttachment, XmATTACH_POSITION,
                                    XmNleftPosition, 0, XmNalignment, XmALIGNMENT_BEGINNING, NULL);
    ...
    form = XtVaCreateWidget("form3", xmFormWidgetClass, rc2, XmNfractionBase, 10, NULL);
    ...
    pEditInfo->IF->port_text = XtVaCreateManagedWidget("port_text",
                                                       ...
                                                       XmNleftPosition, 3,
                                                       XmNtopAttachment,
                                                       XmATTACH_FORM, XmNmaxLength, 5, XmNcolumns, 6, NULL);

    XtManageChild(form);

    form = XtVaCreateWidget("form4", xmFormWidgetClass, rc2, XmNfractionBase, 10, NULL);
    ...
    pEditInfo->IF->trans_menu = XmVaCreateSimpleOptionMenu(rc2, "trans_menu",
                                                           ...
                                                           http_string, 'H',
                                                           NULL, NULL,
                                                           XmVaPUSHBUTTON, cci_string, 'C', NULL, NULL, NULL);
    ...
    trans_rc = XtVaCreateWidget("trans_rc", xmRowColumnWidgetClass, rc, XmNorientation, XmVERTICAL, NULL);

    label = XtVaCreateManagedWidget("Scheme Info", xmLabelWidgetClass, trans_rc, NULL);
    ...
    XtVaSetValues(pEditInfo->translation,
                  ...
                  XmNtopAttachment, XmATTACH_FORM,
                  XmNleftAttachment, XmATTACH_FORM,
                  XmNrightAttachment, XmATTACH_FORM, XmNwidth, 150, XmNvisibleItemCount, 5, XmNmargin, 1, NULL);
    ...
    rc3 = XtVaCreateWidget("rowcolumn3",
                           ...
                           XmNtopAttachment, XmATTACH_WIDGET,
                           XmNtopWidget, pEditInfo->translation, XmNorientation, XmHORIZONTAL, NULL);

    add = XtVaCreateManagedWidget("Add", xmPushButtonWidgetClass, rc3, NULL);

    remove = XtVaCreateManagedWidget("Remove", xmPushButtonWidgetClass, rc3, NULL);

    edit = XtVaCreateManagedWidget("Edit", xmPushButtonWidgetClass, rc3, NULL);
...
void EditProxyDomainInfo(w, client, call, type)
Widget w;
XtPointer client;
XtPointer call;
int type;
{
    ...
    EditProxyDomainDialog = XtVaCreatePopupShell("Proxy Domain",
                                                 ...
                                                 XmNtitle, "Proxy Domain Information", NULL);

    fEditProxyDomainDialog = 1;

    main_form = XtVaCreateWidget("edit_form", xmFormWidgetClass, EditProxyDomainDialog, NULL);
    /*
     ** Create action area widgets
     */
    ...
    form = XtVaCreateWidget("form1", xmFormWidgetClass, rc, XmNfractionBase, 10, NULL);
    ...
    pEditInfo->IF->domain_text = XtVaCreateManagedWidget("domain_text",
                                                         ...
                                                         XmNleftAttachment,
                                                         XmATTACH_POSITION,
                                                         XmNleftPosition, 4, XmNrightAttachment, XmATTACH_FORM, NULL);
...
void CommitProxyInfo(w, client, call)
Widget w;
XtPointer client;
XtPointer call;
{
...
void CommitProxyDomainInfo(Widget w, XtPointer client, XtPointer call)
{
    ...
    if (p->domaintype == ADD) {
        ...
        p->editingDomain->domain = (char *)realloc(p->editingDomain->domain, strlen(domain) + 1);
...
void DismissProxy(w, client, call)
Widget w;
XtPointer client;
XtPointer call;
{
...
#ifdef OTHER_TRANSPORT
void SetOptionMenuButtonLabel(w, s)
Widget w;
char *s;
{
    Widget label;
