...
**	-------------
*/
PRIVATE void HTMLGen_start_element ARGS4(HTStructured *, me,
...
**	TBL 921119
*/
PRIVATE void HTMLGen_end_element ARGS2(HTStructured *, me, int, element_number)
{
    PUTS("</");
...
PUBLIC HTStream *HTPlainToHTML ARGS5(HTPresentation *, pres,
