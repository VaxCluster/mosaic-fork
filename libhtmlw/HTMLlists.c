 ...
 * white space.
 */
struct mark_up *AddObj(listp, current, mark, keep_wsp)
 ...
 * return a pointer to the current (end) position in the list.
 */
struct ele_rec *AddEle(elistp, current, eptr)
 ...
 */
struct ele_rec **MakeLineList(elist, max_line)
 ...
 * Otherwise return 0.
 */
int ElementLessThan(start, end, start_pos, end_pos)
 ...
 * Otherwise return 0.
 */
int SwapElements(start, end, start_pos, end_pos)
struct ele_rec *start;
struct ele_rec *end;
int start_pos, end_pos;
{
 ...
 */
struct ref_rec *FindHRef(list, href)
struct ref_rec *list;
char *href;
{
    struct ref_rec *hptr;
 ...
 */
struct ref_rec *AddHRef(list, href)
struct ref_rec *list;
char *href;
{
    struct ref_rec *hptr;
 ...
 * return a pointer to the element, or NULL if not found.
 */
struct delay_rec *FindDelayedImage(list, src)
struct delay_rec *list;
char *src;
{
    struct delay_rec *iptr;
 ...
 * return a pointer to the head of the new list.
 */
struct delay_rec *AddDelayedImage(list, src)
struct delay_rec *list;
char *src;
{
    struct delay_rec *iptr;
